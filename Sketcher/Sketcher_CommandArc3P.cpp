#include "Sketcher_CommandArc3P.h"
...
void Sketcher_CommandArc3P::CancelEvent()
{
	...
	case Input_2ArcPoint:	myContext->Remove(myRubberLine, Standard_True);
		break;
	case Input_3ArcPoint:	myContext->Remove(myRubberCircle, Standard_True);
		break;
	case Input_PolylineArc: myContext->Remove(myRubberCircle, Standard_True);
		break;
