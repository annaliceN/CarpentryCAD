#include "Sketcher_CommandCircle3Tan.h"
...
void Sketcher_CommandCircle3Tan::CancelEvent()
{
	...
	case Input_2CircleTan: 	myContext->Remove(myRubberLine, Standard_True);
		break;
	case Input_3CircleTan: 	myContext->Remove(myRubberLine, Standard_True);
		myContext->Remove(myRubberCircle, Standard_True);
		break;
	default: break;
	}
