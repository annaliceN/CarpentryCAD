...
void ToolsConfiguration::InitializeTools()
{
	...
	listWidget->setIconSize(QSize(140, 140));
	listWidget->addItem(new QListWidgetItem(QIcon(":/Resources/bandsaw.jpg"), tr("Band Saw")));
	listWidget->addItem(new QListWidgetItem(QIcon(":/Resources/jigsaw.jpg"), tr("Jig Saw")));
	listWidget->addItem(new QListWidgetItem(QIcon(":/Resources/chospaw.jpg"), tr("Chop Saw")));
	listWidget->addItem(new QListWidgetItem(QIcon(":/Resources/drill.jpg"), tr("Drill")));
}
